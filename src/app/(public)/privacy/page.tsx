...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "AnlaşmalıEvlilik.net Privacy Policy: information we collect, how we use it, log files, GDPR/CCPA rights and children's information.",
  path: "/privacy",
  keywords: ["privacy policy", "gdpr", "ccpa", "data protection"],
});
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <div className="mt-6 space-y-6 leading-relaxed text-foreground/90">
        <section>
          <p>
            At {site}, accessible from {site}, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types
            of information that is collected and recorded by {site} and how we
            use it.
          </p>
          <p className="mt-2">
          ...
          <p className="mt-2">
            ...
            that they shared and/or collect in {site}. This policy is not
        ...
        <section>
          ...
          <p className="mt-2">
            {site} follows a standard procedure of using log files. These files
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            advertisements and links that appear on {site}, which are sent
          ...
          <p className="mt-2">
            Note that {site} has no access to or control over these cookies that
