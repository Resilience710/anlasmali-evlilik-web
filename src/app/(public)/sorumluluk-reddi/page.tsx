...
export default async function DisclaimerPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      {custom ? (
        <p className="mt-6 whitespace-pre-line break-words leading-relaxed text-foreground/90">
          {s.disclaimerText}
        </p>
      ) : (
        <div className="mt-6 space-y-6 leading-relaxed text-foreground/90">
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-2 pl-5">
              ...
              <li>
                Genel ahlak kurallarına aykırı ilan ve görsel eklemek yasaktır.
                Bu gibi durumlarda ilanlarınız herhangi bir ön uyarı gerekmeksizin
                silinir.
              </li>
              <li>
              ...
              <li>
                {site}, gerekli gördüğü durumlarda herhangi bir gerekçe
                göstermeden, yayında olan ilanları sahibine haber vermeksizin
                yayından kaldırma hakkını saklı tutar.
              </li>
              <li>
                Aynı amaçla birden fazla hesap açmak kullanım koşullarımıza
                aykırıdır. Bu durumun tespiti halinde üyeliğiniz herhangi bir
                uyarı gerekmeksizin sonlandırılabilir.
              </li>
              <li>
              ...
              <li>
                ...
                mesajlaşma) ait kayıtlar sistemimizde saklanır. Yasalara aykırı
                bir durum veya şikayet halinde bu bilgiler yetkili mercilerle
                paylaşılabilir.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              sonuçlarından sorumlu tutulamaz. Kullanıcılar, tanıştıkları
              kişilerle ilgili gerekli özeni göstermek ve kendi güvenliklerini
      ...
      <section className="mt-6 leading-relaxed text-foreground/90">
