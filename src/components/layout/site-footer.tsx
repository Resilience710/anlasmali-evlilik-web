...
function SocialIcon({
  ...
  return (
    <a
      ...
      aria-label={label}
      className="flex h-9 w-9 items-center justify-center rounded-lg border border-border text-muted-foreground transition-colors hover:bg-elevated hover:text-primary"
    >
      {children}
    </a>
  );
